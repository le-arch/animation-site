...
window.onload = function(){
    ...
    startSound.src = "audio/"+asrcd+".0_07.wav";
    sta
    rtSound.volume = 0.6;
            
    var shootSound = new Audio();
    shootSound.src = "audio/"+asrcd+".0_06";
            
    var hitSound = new Audio();
    hitSound.src = "audio/"+asrcd+".0_05.wav";
            
    var bgSound = new Audio();
    bgSound.src = "audio/"+asrcd+".0_04.wav"//"music.wav";
    bgSound.loop = true;
    //bgSound.volume = 0.8;
            
    var endSound = new Audio();
    endSound.src = "audio/"+asrcd+".0_03.wav";
    endSound.volume = 0.6;
            
    var successSound = new Audio();
    successSound.src = "audio/"+asrcd+".0_02.wav";
            
    var highScoreSound = new Audio();
    highScoreSound.src = "audio/"+asrcd+".0_01.wav";
